...
class TestFiles:
    ...
    def __init__(self):
        ...
        self.TEST_VALID_FASTA_THREE_SEQUENCES = os.path.join(self.test_data, "three_chains.fasta")
        self.TEST_VALID_FASTA_FIVE_SEQUENCES = os.path.join(self.test_data, "five_chains.fasta")
        self.TEST_INVALID_FASTA_ONE_SEQUENCE = os.path.join(self.test_data, "invalid.fasta")
        self.TEST_VALID_5l1z_FIVE_POLYMERS_WITH_TPO_AND_RNA_MMCIF_FILE = os.path.join(self.test_data, "5l1z_refmac1.cif")
        self.TEST_VALID_6fqf_FOUR_POLYMERS_WITH_SAME_SEQUENCE_MMCIF_FILE = os.path.join(self.test_data, "pdb6fqf_refmac1.cif")
